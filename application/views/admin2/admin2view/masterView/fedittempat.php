            ...
            <div class="toggle_container">
                <div class="block">
                    <form id="name" action="<?php echo base_url(); ?>index.php/admin2/dashboar" method="post">
                        ...
                        <input title="Berisi kode alamat" type="text" class="medium required" autofocus> 

                        <label>Nama Tempat</label> 
                        <input title="Berisi nama tempat" type="text" class="large">

                        <label>Alamat</label> 
                        <input title="Berisi Alamat Tempat" type="text" class="large">

                        <label>Telephone</label> 
                        <input title="Berisi no. Telephone" type="text" class="large">

                        <label>Link Peta</label> 
                        <input title="Link Peta Google Maps" type="text" class="large">
