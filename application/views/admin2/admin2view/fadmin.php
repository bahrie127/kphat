<div id="wrapper">
    ...
    <div class="main_container container_16 clearfix">
        <div id="nav_top" class="clearfix round_top">
            <ul class="clearfix">
                <li class="current"><a href=""><img src="<?php echo base_url(); ?>imgadmin2/icons/small/grey/Create Write.png"/>Admin</a></li>
            </ul>
            ...
            <div class="toggle_container">
                ...
                <div id="tabs-1" class="block no_padding">
                    <div id="show21">
                        ...
                        <?php $this->load->view('admin2/admin2view/masterView/ftableadmin'); ?>
                    </div>

                </div>
                <div id="tabs-2" class="block">
                    <?php $this->load->view('admin2/admin2view/masterView/faddadmin'); ?>
                </div>
            </div>
